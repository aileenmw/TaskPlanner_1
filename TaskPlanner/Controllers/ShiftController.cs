...
namespace TaskPlanner.Controllers
{
    public class ShiftController : Controller
    {
        ...
        public IActionResult ShiftTaskAddition()
        {
            ...
            Console.WriteLine("JSON!!!!JSON!!!!JSON!!!!JSON!!!!");
            Console.WriteLine(JsonSerializer.Serialize(HttpContext.Request.Form["taskIds"]));

            int shiftId = Convert.ToInt32(HttpContext.Request.Form["shiftId"]);     

            string taskIds = HttpContext.Request.Form["taskIds"].ToString();

            Console.WriteLine("shiftTask: " + shiftId);
            Console.WriteLine("taskIds: " + taskIds);
